...
import { Button, CircularProgress, Snackbar, SnackbarOrigin } from '@mui/material';
...
export default function Home() {
    ...
    // React.useEffect(() => {
    //     fetch('https://belcor-72f71-default-rtdb.firebaseio.com')
    //         .then(res => res.json())
    ...
    // const handleClickk = (newState: any) => {
